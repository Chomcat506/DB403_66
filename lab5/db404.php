...
?>
        ...
        <div>
            <code>
            SELECT ProductName, UnitPrice, UnitsOnOrder, UnitPrice * UnitsOnOrder AS Amount FROM products WHERE
            UnitPrice * UnitsOnOrder > 500;
            </code>
            <br>
                <table>
                    <tr>
...
?>
        ...
        <div>
            <code>
            SELECT ContactName, ContactTitle, Country FROM customers WHERE ContactTitle = 'Owner' AND Country IN
            ('Mexico', 'Spain', 'France');
            </code>
            <br>
                <table>
...
<?php
    $sql = 'SELECT ContactName, ContactTitle, Country
            FROM customers
            WHERE ContactTitle = "Owner" AND Country IN
            ("Mexico", "Spain", "France")';
    $result = $conn->query($sql);
    while ($row = $result->fetch_assoc()) {
        echo "<tr>
...
?>
        ...
        <div>
            <code>
            SELECT CompanyName, ContactName, ContactTitle, Country FROM customers WHERE ContactTitle = 'Owner'
...
<?php
    $sql = 'SELECT CompanyName, ContactName, ContactTitle, Country
            FROM customers
            WHERE Country IN ("Mexico", "Spain", "France") ORDER BY CompanyName DESC LIMIT 2 ';
    $result = $conn->query($sql);
    while ($row = $result->fetch_assoc()) {
        echo "<tr>
                <td>{$row['CompanyName']}</td>
...
<?php
    $sql = 'SELECT CompanyName, ContactName, ContactTitle, Country
            FROM customers
            WHERE Country IN ("Mexico", "Spain", "France")';
    $result = $conn->query($sql);
    while ($row = $result->fetch_assoc()) {
        echo "<tr>
                <td>{$row['CompanyName']}</td>
...
?>
        ...
        <div>
            <code>
            SELECT ProductName, UnitPrice, QuantityPerUnit FROM products WHERE QuantityPerUnit LIKE '%Box%' ORDER
            BY UnitPrice DESC LIMIT 5;
            </code>
            <br>
                <table>
                    <tr>
...
<?php
    $sql = 'SELECT ProductName, UnitPrice, QuantityPerUnit
            FROM products
            WHERE QuantityPerUnit LIKE "%Box%" ORDER
            BY UnitPrice DESC LIMIT 5';
    $result = $conn->query($sql);
    while ($row = $result->fetch_assoc()) {
        echo "<tr>
...
?>
        ...
        <div>
            <code>
            SELECT country, COUNT(*) AS member FROM customers WHERE country IN ('UK', 'France', 'Spain')
            GROUP BY country;
            </code>
            <br>
                <table>
...
?>
        ...
        <div>
            <code>
            SELECT country, COUNT(*) AS member FROM customers WHERE country IN ('UK', 'France', 'Spain')
            GROUP BY country HAVING member > 5 ORDER BY 2 DESC;
            </code>
            <br>
                <table>
                    <tr>
...
<?php
    $sql = 'SELECT CategoryID, AVG(UnitPrice) avg_price
            FROM products
            WHERE UnitsInStock > 0 GROUP BY CategoryID ';
    $result = $conn->query($sql);
    while ($row = $result->fetch_assoc()) {
        echo "<tr>
